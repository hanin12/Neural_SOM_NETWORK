...
for t=1:T
  alpha=alpha_initial*exp((1-t)/(T/(alpha_initial)));
    sigma=sigma_initial*exp((1-t)/(T/(sigma_initial)));
    max_neighbour_radius=round(neighbour_radius_initial*exp((1-t)/(T/(neighbour_radius_initial))));
